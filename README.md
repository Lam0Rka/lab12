...
## Tutorial
 ...
 Запуск учебного пособия. Откроется в консоли. Доп. ссылки: https://github.com/vim/vim/blob/master/runtime/tutor/tutor.ru
...
```sh
 ...
 Урок 3.4: ПРОДОЛЖАЕМ ИЗМЕНЯТЬ С КОМАНДОЙ. 
...
```
Copyright (c) 2015-2020 The ISC Authors (c)
